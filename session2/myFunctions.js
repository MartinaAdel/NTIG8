...
udpateTask = (updatedTask,index) => {

    let allDivs = document.querySelectorAll('.x')
    console.log(allDivs)
    // console.log(allDivs)
    allDivs[index].childNodes[0].innerHTML=updatedTask.taskTitle
    tasks[index].taskTitle=updatedTask.taskTitle

    allDivs[index].childNodes[1].innerHTML=updatedTask.taskType
    tasks[index].taskTitle=updatedTask.taskTitle

    allDivs[index].childNodes[2].innerHTML=updatedTask.taskContent
    tasks[index].taskTitle=updatedTask.taskTitle

    tasks[index].startDate=updatedTask.startDate
